...
TEST(SegmentManagerTest, DISABLED_SeqWrite) {
  ...
  // Try to allocate a new block should fail trigger ASSERT failure
  // EXPECT_EQ(manager->AllocateFreeBlock(), INVALID_PBA);
